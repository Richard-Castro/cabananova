...
require_once('conexao.php');
	...
	$QTD_SUITE = $_POST['QTD_SUITE'];

	$QTD_GARAGEM = $_POST['QTD_GARAGEM'];
	...
	$sql = 'SELECT * FROM imovel
	        ...
	        WHERE ID_GRUPO_IMOVEL = '.$TIPO_IMOVEL.' AND QUARTOS = '.$QTD_QUARTOS.' AND SUITES = '.$QTD_SUITE.' AND VAGAS = '.$QTD_GARAGEM.' ';
